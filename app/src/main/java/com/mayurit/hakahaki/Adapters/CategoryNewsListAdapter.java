...
public class CategoryNewsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CategoryNewsListAdapter(List<NewsListModel> mList) {
        this.mList = mList;
    }

    public CategoryNewsListAdapter(Context context, List<NewsListModel> mList, RecyclerView view) {
        this.mList = mList;
        ctx = context;
